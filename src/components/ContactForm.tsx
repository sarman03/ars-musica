    ...
    <section className="bg-black min-h-screen pt-32 pb-24 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          {/* TikTok */}
          <a href="#" className="w-9 h-9 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-zinc-700 transition-colors">
        ...
        <div className="flex items-center justify-center gap-6 mb-12">
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-300 text-sm">info@example.com</span>
          </div>
        ...
        <form className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="w-full bg-zinc-700 hover:bg-zinc-600 text-white font-bold text-sm uppercase tracking-wider py-4 rounded-lg transition-colors"
          >
            Submit
          </button>
        </form>
