  ...
  return (
    <section className="relative bg-black min-h-screen pt-32 pb-24 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        {/* Heading */}
        <h1
          className={`text-brand-red font-semibold text-4xl md:text-5xl lg:text-6xl tracking-wide uppercase text-center mb-6 transition-[opacity,transform] duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-200 will-change-[opacity,transform] ${
            show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          Let&apos;s Get In Touch
        ...
        >
          ...
          <div className="flex items-start justify-center gap-2 max-w-lg text-left px-4">
        ...
        {/* Form container */}
        <div
          className={`bg-zinc-900 border border-zinc-800 rounded-2xl p-8 transition-[opacity,transform] duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-[600ms] will-change-[opacity,transform] ${
            show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          <ContactFormFields />
